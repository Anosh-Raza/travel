...
function Hero() {
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap_28 lg:py-20 xl:flex-row">
      ...
      <div className="relative flex flex-1 items-start">
        ...
        <div className="flexBetween">
          <div className="flex flex-col">
            <p className="regular-16 text-gray-50">Distance</p>
            <p className="bold-20 text-white">173 KM</p>
          </div>
          <div className="flex flex-col">
            <p className="regular-16 text-gray-50">Elevation</p>
